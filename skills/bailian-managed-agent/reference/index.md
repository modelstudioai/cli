...
| `bl managed-agent capabilities`         | No Auth        | Show operation-level Managed Agents API capabilities                | [managed-agent.md](managed-agent.md) |
