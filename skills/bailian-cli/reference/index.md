...
| `bl asset-center download`          | Download an asset by ID to a local file                                                                                         | [asset-center.md](asset-center.md) |
...
| `bl asset-center oss slr authorize` | Create OSS service-linked role authorization                                                                                    | [asset-center.md](asset-center.md) |
| `bl asset-center oss slr status`    | Check whether OSS service-linked role is authorized                                                                             | [asset-center.md](asset-center.md) |
...
| `asset-center` | `delete`, `download`, `favorite`, `get`, `list`, `oss bind`, `oss show`, `oss slr authorize`, `oss slr status`, `oss unbind`, `oss update`, `stats`, `storage`, `transfer list`, `unfavorite` | [asset-center.md](asset-center.md) |
