...
| `bl plugin install`        | Install a bailian-cli plugin package into ~/.bailian/plugins                                          | [plugin.md](plugin.md)       |
| `bl plugin link`           | Link a local bailian-cli plugin directory                                                             | [plugin.md](plugin.md)       |
| `bl plugin list`           | List installed and discovered bailian-cli plugins                                                     | [plugin.md](plugin.md)       |
| `bl plugin remove`         | Remove an installed bailian-cli plugin                                                                | [plugin.md](plugin.md)       |
