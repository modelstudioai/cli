...
| `bl memory profile update`       | API Key        | Update a profile schema name, description, or attributes                                                           | [memory.md](memory.md)         |
...
| `memory`     | `add`, `delete`, `list`, `profile create`, `profile delete`, `profile get`, `profile list`, `profile show`, `profile update`, `search`, `update`                                                                                                                                                                                                                                                                                                                                            | [memory.md](memory.md)         |
