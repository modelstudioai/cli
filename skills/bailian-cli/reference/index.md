...
| `bl security alerts`             | API Key        | List Agent security alerts                                                                       | [security.md](security.md)     |
| `bl security overview`           | API Key        | Show the Agent security protection overview (last 24 hours)                                      | [security.md](security.md)     |
...
| `security`   | `alerts`, `overview`                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | [security.md](security.md)     |
