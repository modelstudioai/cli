...
| `bl agents security alerts`      | API Key        | List Agent security alerts                                                                                         | [agents.md](agents.md)         |
| `bl agents security overview`    | API Key        | Show the Agent security protection overview (last 24 hours)                                                        | [agents.md](agents.md)         |
| `bl alert create`                | Console        | Create a model alert rule from an alert template                                                                   | [alert.md](alert.md)           |
| `bl alert delete`                | Console        | Delete model alert rules                                                                                           | [alert.md](alert.md)           |
| `bl alert disable`               | Console        | Disable a model alert rule (keeps the rule, stops notifications)                                                   | [alert.md](alert.md)           |
| `bl alert enable`                | Console        | Enable a model alert rule                                                                                          | [alert.md](alert.md)           |
| `bl alert history`               | Console        | List model alert history (firing and recovered events)                                                             | [alert.md](alert.md)           |
| `bl alert list`                  | Console        | List model alert rules                                                                                             | [alert.md](alert.md)           |
| `bl alert metrics`               | Console        | List metrics that alert rules can be created on, with supported aggregations                                       | [alert.md](alert.md)           |
| `bl alert template create`       | Console        | Create a custom alert template (or copy an official one with --from)                                               | [alert.md](alert.md)           |
| `bl alert template delete`       | Console        | Delete custom alert templates (official templates cannot be deleted)                                               | [alert.md](alert.md)           |
| `bl alert template list`         | Console        | List alert templates (official and custom); pass --template-id for details                                         | [alert.md](alert.md)           |
| `bl alert template update`       | Console        | Update a custom alert template (full replacement of conditions)                                                    | [alert.md](alert.md)           |
| `bl alert update`                | Console        | Update a model alert rule (full replacement; same fields as create)                                                | [alert.md](alert.md)           |
...
| `bl knowledge doc import`        | API Key        | Import existing data-center files into an existing knowledge base                                                  | [knowledge.md](knowledge.md)   |
...
| `bl log audit count`             | Console        | Count model audit logs in a time range (useful before exporting)                                                   | [log.md](log.md)               |
| `bl log audit disable`           | Console        | Disable audit log delivery for all models in the workspace                                                         | [log.md](log.md)               |
| `bl log audit enable`            | Console        | Enable audit log delivery to SLS (SLR authorization → SLS instance → log switch)                                   | [log.md](log.md)               |
| `bl log audit get`               | Console        | Show a single audit log entry with its raw origin record                                                           | [log.md](log.md)               |
| `bl log audit list`              | Console        | Query model audit logs (call metadata; request/response content is not recorded)                                   | [log.md](log.md)               |
| `bl log inference count`         | Console        | Count model inference logs in a time range (useful before exporting)                                               | [log.md](log.md)               |
| `bl log inference disable`       | Console        | Disable inference log delivery for all models in the workspace                                                     | [log.md](log.md)               |
| `bl log inference enable`        | Console        | Enable inference log delivery to SLS (SLR authorization → SLS instance → log switch)                               | [log.md](log.md)               |
| `bl log inference get`           | Console        | Show a single inference log entry with full request/response content                                               | [log.md](log.md)               |
| `bl log inference list`          | Console        | Query model inference logs (requires inference log delivery; use `log inference get` for request/response content) | [log.md](log.md)               |
| `bl log status`                  | Console        | Show model log delivery status (SLS authorization, audit / inference service and switches)                         | [log.md](log.md)               |
| `bl log trace get`               | Console        | Show a single call trace with its span tree                                                                        | [log.md](log.md)               |
| `bl log trace list`              | Console        | List call traces for a model or app                                                                                | [log.md](log.md)               |
| `bl log trace stats`             | Console        | Show per-resource trace statistics (calls, tokens, latency)                                                        | [log.md](log.md)               |
| `bl mcp call`                    | API Key        | Call a tool on an MCP server (tools/call)                                                                          | [mcp.md](mcp.md)               |
| `bl mcp connect`                 | API Key        | Register a Bailian MCP server in an Agent's native configuration                                                   | [mcp.md](mcp.md)               |
| `bl mcp disconnect`              | No Auth        | Remove an unchanged MCP registration previously managed by bailian-cli                                             | [mcp.md](mcp.md)               |
...
| `bl model code`                  | No Auth        | Print a ready-to-run SDK sample for calling a model                                                                | [model.md](model.md)           |
...
| `bl model search`                | No Auth        | Search the model catalog by keyword, ranked by relevance                                                           | [model.md](model.md)           |
| `bl monitor delivery disable`    | Console        | Disable monitor delivery for all models in the workspace                                                           | [monitor.md](monitor.md)       |
| `bl monitor delivery enable`     | Console        | Activate monitoring delivery: CMS SLR authorization, CMS service, and the dedicated Prometheus instance            | [monitor.md](monitor.md)       |
| `bl monitor delivery status`     | Console        | Show monitoring delivery (Prometheus instance) status                                                              | [monitor.md](monitor.md)       |
| `bl monitor errors`              | Console        | Show failure breakdown by HTTP status code and error code                                                          | [monitor.md](monitor.md)       |
| `bl monitor metrics`             | Console        | Query time-series monitor metrics (RPM/TPM, latency percentiles, token usage)                                      | [monitor.md](monitor.md)       |
| `bl monitor models`              | Console        | List per-model / per-API-key call statistics with server-side sort and paging                                      | [monitor.md](monitor.md)       |
| `bl monitor overview`            | Console        | Show aggregated model call statistics (calls, failures, latency, token usage)                                      | [monitor.md](monitor.md)       |
...
| `agents`     | `security alerts`, `security overview`                                                                                                                                                                                                                                                                                                                                                                                                                                                        | [agents.md](agents.md)         |
| `alert`      | `create`, `delete`, `disable`, `enable`, `history`, `list`, `metrics`, `template create`, `template delete`, `template list`, `template update`, `update`                                                                                                                                                                                                                                                                                                                                     | [alert.md](alert.md)           |
...
| `knowledge`  | `category add`, `category delete`, `category list`, `chat`, `chunk add`, `chunk delete`, `chunk list`, `chunk update`, `collection create`, `collection get`, `create`, `delete`, `doc delete`, `doc import`, `doc import-oss`, `doc list`, `doc status`, `doc tag`, `doc upload`, `file delete`, `file get`, `file list`, `info`, `list`, `search`, `service copy`, `service create`, `service delete`, `service deploy`, `service get`, `service list`, `service update`, `stats`, `update` | [knowledge.md](knowledge.md)   |
| `log`        | `audit count`, `audit disable`, `audit enable`, `audit get`, `audit list`, `inference count`, `inference disable`, `inference enable`, `inference get`, `inference list`, `status`, `trace get`, `trace list`, `trace stats`                                                                                                                                                                                                                                                                  | [log.md](log.md)               |
| `mcp`        | `call`, `connect`, `disconnect`, `list`, `tools`                                                                                                                                                                                                                                                                                                                                                                                                                                              | [mcp.md](mcp.md)               |
| `model`      | `code`, `list`, `search`                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | [model.md](model.md)           |
| `monitor`    | `delivery disable`, `delivery enable`, `delivery status`, `errors`, `metrics`, `models`, `overview`                                                                                                                                                                                                                                                                                                                                                                                           | [monitor.md](monitor.md)       |
