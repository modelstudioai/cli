...
/**
 * E2E 专用全量路由表（与产品 map 独立维护）。
 * 新增/删改命令时须同步：commands 实现、产品 map、本文件。
 */
export const e2eCommandMap: Record<string, AnyCommand> = {
...
/** 须在 e2eCommandMap 中出现至少一次的 commands export（契约测试用） */
export const E2E_COMMAND_EXPORTS = [
  authLogin,
  authStatus,
  authLogout,
  textChat,
