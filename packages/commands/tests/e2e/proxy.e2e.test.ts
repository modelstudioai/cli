...
import { commandsPackageRoot } from "./setup.ts";

const execFileAsync = promisify(execFile);

const runtimeProxyTs = join(commandsPackageRoot, "..", "runtime", "src", "proxy.ts");
 ...
 */
const PROBE_SCRIPT = `
import { setupProxyFromEnv } from ${JSON.stringify(runtimeProxyTs)};
setupProxyFromEnv();
try {
